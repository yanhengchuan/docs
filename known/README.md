...
[![mips64le/known build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/known.svg?label=mips64le/known%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/known/)
...
```bash
docker run --link some-mysql:db -d mips64le/known
```
