...
[![mips64le/sourcemage build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/sourcemage.svg?label=mips64le/sourcemage%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/sourcemage/)
...
```shell
$ docker run -it mips64le/sourcemage
```

or

```shell
$ docker run -it mips64le/sourcemage:0.62
```
