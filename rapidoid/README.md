...
[![mips64le/rapidoid build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/rapidoid.svg?label=mips64le/rapidoid%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/rapidoid/)
...
```console
$ docker run --rm mips64le/rapidoid --help
```
