...
[![mips64le/sl build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/sl.svg?label=mips64le/sl%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/mips64le/job/sl/)
...
```console
$ docker pull mips64le/sl
$ docker run -it mips64le/sl:6 cat /etc/redhat-release
$ docker run -it mips64le/sl:7 cat /etc/redhat-release
```
